 ...
 * @author LiuJin
 */
public class DriverActiveAction extends DefaultAction<JComboBox> {
    
    private final int nextFocus;
    private final boolean editable;
    
    public DriverActiveAction(int nextFocus) {
        this.nextFocus = nextFocus;
        this.editable = true;
    }
    
    public DriverActiveAction(int nextFocus, boolean editable) {
        this.nextFocus = nextFocus;
    ...
    private class SwipeCardTask extends SwingWorker<String, Integer> {
        ...
        protected void done() {
            try {
                ...
                if (cardNumber == null || cardNumber.length() == 0) {
                    switch (actionCommand) {
                        ...
                        case "ACTION3":
                            ...
                            return;
                        default:
                            getLogger(DriverActiveAction.class.getName()).log(Level.WARNING,
                ...
                getLogger(DriverActiveAction.class.getName()).log(Level.SEVERE, null, ex);
                showMsg(owner.getTopLevelAncestor(),
